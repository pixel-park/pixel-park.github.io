...
function Experience() {
    const exper: exp[] = [
        { role: `JavaScript Fullstack/Three.js Developer`, company: { title: 'CommeScope', href: 'https://www.commscope.com/' }, place: 'Belgium-Online', period: 'September 2022 - Present', id: 1 },
